...
class Test_Credence_002:
    ...
    def test_CredKart_Login_008(self):
        ...
        driver.find_element(By.XPATH, "//input[@name='email']").send_keys("bhushan_aloni@yahoo.com")
        driver.find_element(By.CSS_SELECTOR, "input[id='password']").send_keys("Bhushan@123")
